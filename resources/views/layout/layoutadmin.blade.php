...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="/" class="logo"><b>FI<span>AN</span></b></a>
      <!--logo end-->
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a class="active" href="javascript:;">
             ...
             <ul class="sub">
              <li <?php if($thisPage == "author") echo "class='active'"; ?>>
                <a href="/author">Author Table</a>
              </li>
              <li <?php if($thisPage == "news") echo "class='active'"; ?>>
                <a href="/news">News Table</a>
              </li>
            </ul>
          </li>
